...
export const getWorkReviews = (id) => {
  return (dispatch) => {
    return axios.get('/api/works/' + id + '/reviews/')
      .then((res) => {
...
export const getRecWorks = () => {
  return (dispatch) => {
    return axios.get('/api/works/recommend')
      .then((res) => {
...
export const getSearchWorks = () => {
  return (dispatch) => {
    return axios.get('/api/works/search')
      .then((res) => {
