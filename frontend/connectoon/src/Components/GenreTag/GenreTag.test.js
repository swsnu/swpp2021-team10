...
describe('<GenreTag />', () => {
  it('should render GenreTag', () => {
    ...
    const component = shallow(<GenreTag tagName={tagName} deletable={false} selected={true} />);
  ...
  it('should show delete button', () => {
    const component = shallow(<GenreTag tagName="tagName" deletable={true} selected={true} />);
